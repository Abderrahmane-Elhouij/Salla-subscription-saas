<?php
    ...
    * @copyright 2025
    * @version 1.00: _membership_edit.tpl.php, v1.00 4/13/2025 2:41 PM
    *
    */
   if (!defined('_WOJO')) {
...
?>
<h2><?php echo Language::$word->MEM_SUB2;?></h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (periodSelect && !periodSelect.value) {
        ...
        if (periodSelect.options.length > 0) {
            ...
            // Set a default value if no options exist
            periodSelect.value = '<?php echo $this->data->period; ?>';
        }
    }
