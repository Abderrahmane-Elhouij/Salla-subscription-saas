...
?>
    ...
    <div class="row gutters">
        ...
        <div class="column shrink mobile-100">
            <a href="<?php //echo Url::url(Router::$path, "new/"); ?>" class="wojo primary stacked button"><i
                        class="icon plus alt"></i><?php //echo Language::$word->MEM_SUB1; ?></a>
        </div>
    </div>
    -->
                  ...
                  -->
                        <div class="columns auto">
                            <a href="<?php echo Url::url(Router::$path, 'edit-salla-product/' . $row->id); ?>"
                               class="wojo icon inverted primary button" title="Edit on Salla">
                                <i class="icon pencil"></i>
                            </a>
                        </div>
                        <div class="columns auto">
