...
<?php if (!$this->data): ?>
    <div class="wojo segment content-center">
        ...
        <p class="wojo small thick caps text"><?php echo Language::$word->SUB_NO_SUBSCRIPTIONS; ?></p>
    </div>
<?php else: ?>
    ...
    <div class="wojo segment shadow">
        <div class="row small gutters align-middle spaced">
            <div class="columns auto">
                <h4 class="wojo text"><?php echo Language::$word->SUB_SUBSCRIPTIONS; ?></h4>
            </div>
            <div class="columns right aligned">
                <div class="filter-dropdown">
                    <button class="wojo small secondary button" id="filterButton">
                        <i class="icon filter"></i> <?php echo Language::$word->SUB_CUSTOMIZE_VIEW; ?>
                    </button>
                    <div class="filter-content" id="filterDropdown">
                        <!-- Membership Information -->
                        <div class="filter-section">
                            <div class="filter-section-title"><?php echo Language::$word->SUB_MEMBERSHIP_INFO_FILTER; ?></div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                    <input type="checkbox" data-column="membership-title" checked>
                                    <span class="slider"></span>
                                </label>
                                <span class="filter-option-label"><?php echo Language::$word->SUB_MEMBERSHIP_TITLE; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_MEMBERSHIP_PRICE; ?></span>
                            </div>
                        </div>

                        <!-- Customer Information -->
                        <div class="filter-section">
                            <div class="filter-section-title"><?php echo Language::$word->SUB_CUSTOMER_INFO_FILTER; ?></div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                    <input type="checkbox" data-column="customer-name" checked>
                                    <span class="slider"></span>
                                </label>
                                <span class="filter-option-label"><?php echo Language::$word->SUB_CUSTOMER_NAME; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_CUSTOMER_EMAIL; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_CUSTOMER_PHONE; ?></span>
                            </div>
                        </div>
                        <!-- Period Information -->
                        <div class="filter-section">
                            <div class="filter-section-title"><?php echo Language::$word->SUB_PERIOD_INFO; ?></div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                    <input type="checkbox" data-column="start-date" checked>
                                    <span class="slider"></span>
                                </label>
                                <span class="filter-option-label"><?php echo Language::$word->SUB_START_DATE; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_END_DATE; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_REMAINING; ?></span>
                            </div>
                        </div>

                        <!-- Status Information -->
                        <div class="filter-section">
                            <div class="filter-section-title"><?php echo Language::$word->SUB_STATUS_ACTIONS; ?></div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                    <input type="checkbox" data-column="status" checked>
                                    <span class="slider"></span>
                                </label>
                                <span class="filter-option-label"><?php echo Language::$word->SUB_STATUS_FILTER; ?></span>
                            </div>
                            <div class="filter-option">
                                <label class="filter-toggle">
                                ...
                                <span class="filter-option-label"><?php echo Language::$word->SUB_ACTION_BUTTONS; ?></span>
                            </div>
                        </div>
                        ...
                        <div class="filter-actions">
                            <div>
                                <button class="filter-btn reset-btn"
                                        id="resetFilters"><?php echo Language::$word->SUB_RESET; ?></button>
                            </div>
                            <div>
                                <button class="filter-btn apply-btn"
                                        id="applyFilters"><?php echo Language::$word->SUB_APPLY_FILTERS; ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <table class="wojo basic responsive table">
            <thead>
            <tr>
                <th class="center aligned"><?php echo Language::$word->SUB_ID; ?></th>
                <th class="membership-column"><?php echo Language::$word->SUB_MEMBERSHIP; ?></th>
                <th class="customer-column"><?php echo Language::$word->META_T28; ?></th>
                <th class="period-column"><?php echo Language::$word->SUB_PERIOD; ?></th>
                <th><?php echo Language::$word->SUB_STATUS; ?></th>
                <th class="center aligned"><?php echo Language::$word->SUB_ACTIONS; ?></th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($this->data as $row): ?>
                <tr id="item_<?php echo $row->id; ?>">
                    <td class="center aligned"><span
                                class="wojo small primary inverted circular label"><?php echo $row->id; ?></span></td>
                    ...
                    <td class="period-column">          <!-- Start Date -->
                        <div class="wojo small icon text start-date">
                            <i class="icon calendar outline"></i>
                            <span><?php echo Language::$word->SUB_START_DATE; ?>: <?php echo Date::doDate("short_date", $row->start_date); ?></span>
                        </div>

                        <!-- End Date -->
                        <div class="wojo small icon text end-date">
                            <i class="icon calendar alt"></i>
                            <span><?php echo Language::$word->SUB_END_DATE; ?>: <?php echo Date::doDate("short_date", $row->end_date); ?></span>
                        </div>
                        ...
                        <div class="wojo small <?php echo $label_class; ?> text days-left">
                            <?php echo $days_left > 0 ? $days_left . ' ' . Language::$word->SUB_DAYS_LEFT : Language::$word->SUB_EXPIRED; ?>
                        </div>
                    </td>
                    <td>
                    ...
                    <td class="center aligned"><a href="<?php echo Url::url(Router::$path, "detail/" . $row->id); ?>"
                                                  class="wojo icon primary inverted circular button"
                                                  data-tooltip="<?php echo Language::$word->SUB_VIEW_DETAIL; ?>">
                            <i class="icon eye"></i>
                        </a>
                        <?php if ($row->salla_order_id): ?>
                            <a href="<?php echo Url::url(Router::$path, "update-order/" . $row->id); ?>"
                               class="wojo icon primary inverted circular button"
                               data-tooltip="<?php echo Language::$word->SUB_UPDATE_ORDER; ?>">
